...
|     | sequential | parallel |
| --- | ---------- | -------- |
| normalized (unbatched) | ![](https://github.com/adamzterenyi/twitter_postgres_parallel/workflows/tests_normalized_sequential/badge.svg) | ![](https://github.com/adamzterenyi/twitter_postgres_parallel/workflows/tests_normalized_parallel/badge.svg) |
| normalized (batched) | ![](https://github.com/adamzterenyi/twitter_postgres_parallel/workflows/tests_normalizedbatch_sequential/badge.svg) |  ![](https://github.com/adamzterenyi/twitter_postgres_parallel/workflows/tests_normalizedbatch_parallel/badge.svg) |
| denormalized | ![](https://github.com/adamzterenyi/twitter_postgres_parallel/workflows/tests_denormalized_sequential/badge.svg) | ![](https://github.com/adamzterenyi/twitter_postgres_parallel/workflows/tests_denormalized_parallel/badge.svg) |
...
| -----------------------| ------------------------- | ------------------------- |
| `pg_normalized`        | 7m59.895s                 | 76.83s                    | 
| `pg_normalized_batch`  | 2m53.235s                 | 28.99s                    | 
| `pg_denormalized`      | 0m17.894s                 | 6.41s                     | 
